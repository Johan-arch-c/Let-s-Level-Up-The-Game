...
FONT_SIZE=72
pygame.init()
background_image=pygame.transform.scale(pygame.image.load("OIP.webp"),(SCREEN_WIDTH, SCREEN_HEIGHT))
...
class Sprite(pygame.sprite.Sprite):
    ...
    def move(self,x_change,y_change):
        ...
        self.rect.y=max(min(self.rect.y + x_change, SCREEN_HEIGHT - self.rect.height),0)
